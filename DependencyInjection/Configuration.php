            ...
            ->children()
                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('calendar')->isRequired()->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('membership')->isRequired()->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('lime_calendar.membership')->end()
                                ->scalarNode('name')->defaultValue('lime_calendar_membership')->end()
                            ->end()
                        ->end()
                        ->arrayNode('event')->isRequired()->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('participant')->isRequired()->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('lime_calendar.participant')->end()
                                ->scalarNode('name')->defaultValue('lime_calendar_participant')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('service')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('form')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('username_transformer')->cannotBeEmpty()->defaultValue('lime_calendar.form.username_transformer.default')->end()
                            ->end()
                        ->end()
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('membership')->cannotBeEmpty()->defaultValue('lime_calendar.form_factory.membership.default')->end()
                                ->scalarNode('event')->cannotBeEmpty()->defaultValue('lime_calendar.form_factory.event.default')->end()
                                ->scalarNode('participant')->cannotBeEmpty()->defaultValue('lime_calendar.form_factory.participant.default')->end()
                            ->end()
                        ->end()
