                    ...
                    ->children()
                        ->arrayNode('manager')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('membership')->cannotBeEmpty()->defaultValue('lime_calendar.manager.membership.default')->end()
                                ->scalarNode('event')->cannotBeEmpty()->defaultValue('lime_calendar.manager.event.default')->end()
                                ->scalarNode('participant')->cannotBeEmpty()->defaultValue('lime_calendar.manager.participant.default')->end()
                            ->end()
                        ->end()
                        ...
                        ->arrayNode('blamer')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('membership')->cannotBeEmpty()->defaultValue('lime_calendar.blamer.security')->end()
                                ->scalarNode('event')->cannotBeEmpty()->defaultValue('lime_calendar.blamer.security')->end()
                                ->scalarNode('participant')->cannotBeEmpty()->defaultValue('lime_calendar.blamer.security')->end()
                            ->end()
                        ->end()
